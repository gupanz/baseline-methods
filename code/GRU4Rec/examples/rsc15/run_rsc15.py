...
PATH_TO_TRAIN = '../../../../data/Taobao/train.tsv'
PATH_TO_TEST = '../../../../data/Taobao/test.tsv'
...
if __name__ == '__main__':
    ...
    gru = gru4rec.GRU4Rec(loss='top1', final_act='tanh', hidden_act='tanh', layers=[100], batch_size=50, dropout_p_hidden=0.5, learning_rate=0.01, momentum=0.0, time_sort=False,
                          session_key='SessionId', item_key='ItemId', time_key='Timestamp')
    gru.fit(data)
    res = evaluation.evaluate_gpu(gru, valid, session_key='SessionId', item_key='ItemId', time_key='Timestamp')
