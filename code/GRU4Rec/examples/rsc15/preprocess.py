...
PATH_TO_ORIGINAL_DATA = '../../../../data/Taobao/'
PATH_TO_PROCESSED_DATA = '../../../../data/Taobao/'

data = pd.read_csv(PATH_TO_ORIGINAL_DATA + 'interactions.csv', sep=',', nrows=10000, usecols=[1, 4, 6], dtype={0: np.int64, 1: str, 2: np.int64})
